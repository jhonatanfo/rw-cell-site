...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 box-banner-interna">
                    <h1 data-aos="fade-up">Loja 01 - RW Cell</h1>
                </div>
            </div>
        </div>
    </section>

    <section class="bg-chamada-lojas-internas">
        <div class="container">
            <div class="chamada-lojas-internas">

                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 left" data-aos="fade-right">
                        <i></i>
                        <h2>Loja 01 - RW Cell</h2>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 right" data-aos="fade-left">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <img src="content/img/quem-somos-02.png" class="img-responsive" data-aos="fade-right">
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <h3 data-aos="fade-up">Estamos sempre prontos para te atender. </h3>
                    <p data-aos="fade-up">A Rw Cell, é uma empresa focada na manutenção de CELULARES, TABLETS em geral e também assessoria
                        para uso e configuração do celular. Estamos sempre nos atualizando junto as fábricas para
                        oferecer um serviço de qualidade e estar sempre um passo à frente em relação a nossos
                        concorrentes, nossa equipe encontra-se em constante processo de aperfeiçoamento. </p>
                    <p data-aos="fade-up">Por esse motivo estamos sempre atentos a toda e qualquer novidade lançada no mercado para prestar
                        a nossos clientes um serviço de qualidade. A Rw Cell dispõe de uma equipe de profissionais
                        capacitados e que possuem cursos ministrados pela fábrica, estando aptos a realizar reparos em
                        IPhone, Samsung Galaxy, Sony Xperia, Lg, Microsoft e muito mais. </p>
                    <p data-aos="fade-up"><b>Estamos localizados em um dos melhores pontos de São Paulo, Av Prof. Alfonso Bovero 1169 muito
                            conhecida e de fácil acesso. Próximo às estações vila Madalena e Sumaré</b></p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4 box-left">
                    <div class="box-nossos-servicos" data-aos="fade-right">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 box-center">
                    <div class="box-nossos-servicos principal" data-aos="fade-up">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 box-right">
                    <div class="box-nossos-servicos" data-aos="fade-left">
    ...
    <section class="bg-loja-galeria">
        ...
        <ul class="list-unstyled" id="lightgallery">
            ...
            <li data-src="content/img/galeria-01.jpg" data-aos="fade-up">
                <img src="content/img/galeria-01.jpg">
            </li>
            
            <li data-src="content/img/galeria-02.jpg" data-aos="fade-up">
                <img src="content/img/galeria-02.jpg">
            </li>

            <li data-src="content/img/galeria-03.jpg" data-aos="fade-up">
                <img src="content/img/galeria-03.jpg">
            </li>

            <li data-src="content/img/galeria-04.jpg" data-aos="fade-up">
                <img src="content/img/galeria-04.jpg">
            </li>

            <li data-src="content/img/galeria-05.jpg" data-aos="fade-up">
                <img src="content/img/galeria-05.jpg">
            </li>

            <li data-src="content/img/galeria-06.jpg" data-aos="fade-up">
    ...
    <section class="lojas-internas-orcamento">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 data-aos="fade-up">Entre em contato e faça o seu orçamento</h2>
                    ...
                    <form>
                        ...
                        <label data-aos="fade-up">
                            <input class="mensagem" type="text" id="mensagem" placeholder="Como podemos te ajudar? Escreva aqui a sua mensagem">
    ...
    <section class="mapa ativo">
        <button data-aos="fade-up">Veja como chegar</button>
